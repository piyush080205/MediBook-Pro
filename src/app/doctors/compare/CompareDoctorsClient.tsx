...
export default function CompareDoctorsClient() {
            ...
            <Table>
                      ...
                      >
                        <div className="flex flex-col items-center gap-2">
                          <Avatar className="h-20 w-20">
                            {doctorImage && (
                              <AvatarImage src={doctorImage.imageUrl} />
                            )}
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  {doctors.map((doctor) => (
                    <TableCell key={doctor.id} className="text-center">
                      {doctor.ratings.avg.toFixed(1)} ({doctor.ratings.count} reviews)
                    </TableCell>
                  ))}
                </TableRow>
                ...
                <TableRow>
                  <TableCell className="font-semibold flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-red-500" /> Primary Clinic
                  </TableCell>
                  {doctors.map((doctor) => (
                    <TableCell key={doctor.id} className="text-center text-xs">
                      {doctor.clinics[0].name},{" "}
                      {doctor.clinics[0].location.address}
                    </TableCell>
                  ))}
                </TableRow>
